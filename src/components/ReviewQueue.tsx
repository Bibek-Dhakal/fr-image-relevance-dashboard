            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">AI
                            Status
                        </th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Reason</th>
                        <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Human
                            Override
                        </th>
                    </tr>
                    </thead>
                                ...
                                {rev.human_status ? (
                                    ...
                                    <div className="flex justify-end space-x-2">
                                        <button
                                            ...
                                            className="text-green-600 hover:text-green-900 border border-green-200 bg-green-50 px-3 py-1 rounded transition-colors"
                                        >
                                            Approve
                                        </button>
                                        <button
                                            onClick={() => handleAction(rev.id, 'reject')}
                                            className="text-red-600 hover:text-red-900 border border-red-200 bg-red-50 px-3 py-1 rounded transition-colors"
                                        >
                                            Reject
                                        </button>
                                    </div>
